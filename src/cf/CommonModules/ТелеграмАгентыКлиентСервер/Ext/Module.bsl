...
Функция ОбязательныеРеквизитыАгента() Экспорт
	
	ОбязательныеРеквизиты = Новый Массив;
	ОбязательныеРеквизиты.Добавить("НомерТелефона");
	ОбязательныеРеквизиты.Добавить("РасположениеTDDB");
	ОбязательныеРеквизиты.Добавить("ИдентификаторПриложения");
	ОбязательныеРеквизиты.Добавить("ХэшПриложения");
...
Функция ЗапросУстановкаПараметровTDLib(РасположениеTDDB = Неопределено, ИдентификаторПриложения, ХэшПриложения) Экспорт
	
	Запрос = Новый Соответствие;
	Запрос.Вставить("@type", "setTdlibParameters");				
	Запрос.Вставить("parameters", ТелеграмАгентыКлиентСервер.ПараметрыКомпоненты(РасположениеTDDB), ИдентификаторПриложения, ХэшПриложения);
